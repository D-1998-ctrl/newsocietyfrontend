...
function App() {
  ...
  <Route path="/" element={<SocietyList />} />
  ...
  <Route path="/app" element={<Sidebar />}>
    ...
    <Route path="settings" element={<Settings />} />
      ...
      <Routes>
        ...
        <Route path="/signup" element={<Signup />} />
        <Route path="/societyList" element={<SocietyList />} />
        ...
        <Route path="/app" element={<Sidebar />}>
          ...
          <Route path="invoice" element={<InvoicesNav />}>
            <Route path="billinvoice" element={<BillInvoice />} />
            <Route path="CreateService" element={<Service />} />
             <Route path="InvoiceTemplate" element={<CommonPage />} />
             <Route path="DemoInvoice" element={<CommonPage />} />
          </Route>

...
const Organization = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const url = `${REACT_APP_URL}/Organisation/${societyId }`
            console.log('url', url)
            const method = "PATCH"
    ...
    const handleEdit = async () => {
        ...
        setAddress1(societyData?.AddressLine1)
        setAddress2(societyData?.AddressLine2)
        setSelectedState(societyData?.State)
        setPincode(societyData ?.Pin)
        setMobileNum(societyData?.Mobile)
        setEmail(societyData?.Email)
        setRegistrationNo(societyData.Registration)
        setRegistrationDate(societyData.RegisteredDate)
        setRegistrationAuthority(societyData.RegisteringAuthority)
        setAddregistrationAuthority(societyData.AddressofRegisteringAuthority)
        setIsEditing(true);
        setIsDrawerOpen(true);
    };
    ...
    useEffect(() => {
        ...
        return (
            <Box display="flex" justifyContent="center" alignItems="center" minHeight={600}>
                <Typography color="text.secondary">Loading society information...</Typography>
            </Box>
        );
    }
    return (
            ...
            <Box>
                    ...
                    <Box display={'flex'} alignItems={'center'} justifyContent={'center'} minHeight={600} mt={2}>
                        ...
                        >
                            ...
                            <Box>
                                <Box mt={1}>
                                    <Typography variant="body" color="var(--primary-color)"><b> {societyData.SocietyName} </b></Typography>
                                </Box>
                                ...
                                <Box mt={2}>
                                    <Box>
                                        <Typography variant="body" color="var(--primary-color)"><b>Address  </b> : </Typography>
                                        <Box>
                                            <Typography color="var(--complementary-color)"><b>{societyData.AddressLine1} {societyData.AddressLine2}, {societyData.State}</b></Typography>
                                        </Box>
                                    </Box>
                                </Box>
                                ...
                                <Box display={'flex'} alignItems="flex-start" justifyContent={'space-between'} gap={4} mt={2}>
                                    <Box display={'flex'} alignItems="flex-start" justifyContent={'space-between'}>
                                        <Typography variant="body" color="var(--primary-color)"><b>Pin Code </b> :  </Typography>
                                        <Box> <Typography color="var(--complementary-color)"><b> {societyData.Pin} </b></Typography></Box>
                                    </Box>

                                    <Box display={'flex'} alignItems={'center'} justifyContent={'space-between'}>
                                        <Typography variant="body" color="var(--primary-color)"><b>Mobile No</b> : </Typography>
                                        <Box><Typography color="var(--complementary-color)" variant="body"><b>{societyData.Mobile}</b></Typography></Box>
                                    </Box>
                                </Box>
                                ...
                                <Box display={'flex'} alignItems="flex-start" justifyContent={'space-between'} gap={4} mt={2}>
                                    <Box display={'flex'} alignItems="flex-start" justifyContent={'space-between'}>
                                        <Typography variant="body" color="var(--primary-color)"><b>Email </b> :  </Typography>
                                        <Box> <Typography color="var(--complementary-color)"><b> {societyData.Email} </b></Typography></Box>
                                    </Box>

                                    <Box display={'flex'} alignItems={'center'} justifyContent={'space-between'}>
                                        <Typography variant="body" color="var(--primary-color)"><b>Registration No</b> : </Typography>
                                        <Box><Typography color="var(--complementary-color)" variant="body"><b>{societyData.Registration}</b></Typography></Box>
                                    </Box>
                                </Box>
                                ...
                                <Box display={'flex'} alignItems="flex-start" justifyContent={'space-between'} gap={4} mt={2}>
                                    <Box display={'flex'} alignItems="flex-start" justifyContent={'space-between'}>
                                        <Typography variant="body" color="var(--primary-color)"><b>Registered Date </b> :  </Typography>
                                        <Box> <Typography color="var(--complementary-color)"><b> {new Date(societyData.RegisteredDate).toLocaleDateString("en-GB")} </b></Typography></Box>
                                    ...
                                    <Box display={'flex'} alignItems={'center'} justifyContent={'space-between'}>
                                        <Typography variant="body" color="var(--primary-color)"><b>Registering Authority</b> : </Typography>
                                        <Box><Typography color="var(--complementary-color)"  variant="body"><b>{societyData.RegisteringAuthority}</b></Typography></Box>
                                    </Box>
                                </Box>
                                ...
                                <Box mt={2}  >
                                    ...
                                    <Typography variant="body" color="var(--primary-color)"><b>Address of Registering Authority: </b> </Typography>
                                    <Box> <Typography color="var(--complementary-color)"><b> {societyData.AddressofRegisteringAuthority} </b></Typography>
                                    </Box>
